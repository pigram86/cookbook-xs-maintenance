...
### Includes XS62ESP1008, XS62ESP1011, & XS62ESP1013

bash "install XS62ESP1015" do
  user "root"
  cwd "/tmp"
  code <<-EOH
  ...
  PATCHUUID=$(xe patch-upload file-name=XS62ESP1015.xsupdate)
  xe patch-pool-apply uuid=${PATCHUUID}

  xe patch-clean uuid=${PATCHUUID}
  EOH
  not_if {::File.exists?(node['hf']['1015'])}
end
