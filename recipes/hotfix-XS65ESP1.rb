...
# Includes XS65E001-008 Hotfixes
bash "install XS65ESP1" do
  user "root"
  cwd "/tmp"
  code <<-EOH
  ...
  PATCHUUID=$(xe patch-upload file-name=XS65ESP1.xsupdate)
  xe patch-pool-apply uuid=${PATCHUUID}

  xe patch-clean uuid=${PATCHUUID}
  EOH
  not_if {::File.exists?(node['xs65']['sp1'])}
end
