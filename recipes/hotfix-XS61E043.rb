...
bash "install XS61E043" do
  ...
  wget http://downloadns.citrix.com.edgesuite.net/9702/XS61E043.zip
  unzip XS61E043.zip

  . /etc/xensource-inventory

  PATCHUUID=$(xe patch-upload file-name=XS61E043.xsupdate)
